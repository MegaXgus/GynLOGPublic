...
private void liberarCampos() {
    ...
    private void filtrarTabela() {
       try {
        ...
        for (Veiculo obj : lista) {
            ...
            if (statusIndex == 0) { 
                if (!obj.getStatus().toLowerCase().contains("ativo")) {
                    combina = false;
                }
            } else if (statusIndex == 1) { 
                if (!obj.getStatus().toLowerCase().contains("inativo")) {
                    combina = false;
                }
            }
    ...
    }//GEN-LAST:event_jButtonConsultarVeiculoActionPerformed
    ...
    if (row >= 0) {
        ...
        if ("EDITAR".equals(modo)) {
            jTextFieldIdVeiculo.setEditable(false); // ID não altera
            jTextFieldMarca.setEditable(true);
            jTextFieldModelo.setEditable(true);
            jTextFieldPlaca.setEditable(true);
            jTextFieldAnoFabricacao.setEditable(true);
...
// ... (o restante das suas variáveis deve seguir aqui)
// ...
// End of variables declaration                   
 // ESTA É A CHAVE QUE FECHA A CLASSE
